...
import { UserPlus, Eye, EyeOff, CreditCard, Building, User, Hash } from 'lucide-react'; // Added Hash here
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.userType === 'client') {
      if (!formData.accountNumber) {
        newErrors.accountNumber = 'Account number is required for client registration';
      } else if (!/^ACC\d{9}$/.test(formData.accountNumber)) {
        newErrors.accountNumber = 'Account number must be in format ACC followed by 9 digits (e.g., ACC001234567)';
      }
    }
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Account Number (only for clients) */}
            {formData.userType === 'client' && (
              <div className="relative">
                <Input
                  ...
                  placeholder="Enter your account number (ACC001234567)"
                  helperText="Format: ACC followed by 9 digits"
                  required
                />
